#!/usr/bin/env python3
"""Ejecuta exactamente 72 horas wall-clock; no comprime el tiempo."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--report", default="runs/triade_verify_live/phase_17/runtime_72h.json"
    )
    ...
    report["window"] = "72h" if args.duration_seconds == 259_200 else "short_validation"
