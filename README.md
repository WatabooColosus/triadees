...
Reproducción y límites: [`docs/operations/triade_verify.md`](docs/operations/triade_verify.md).
...
**Límite actual:** el benchmark longitudinal determinista verificó recuperación,
aislamiento, contradicciones y restore con los umbrales iniciales, pero ese corpus no
demuestra rendimiento universal ni memoria permanente. La operación debe conservar
procedencia, scopes y backups verificados.
...
**Marco funcional de continuidad verificable:**
...
federada de nodos autorizados. Una prueba local usó dos procesos reales y transporte
TCP para verificar firma, reproducción, idempotencia y revocación. La federación
sostenida entre hosts sigue siendo **experimental**, no una capacidad de producción.
...
Estado real del proyecto (corte operativo 2026-07-30; el versionado histórico no
