...
app = FastAPI(title="Tríade Ω Single Port", version="0.4.0")
...
<h2>Tríade Ω</h2><p style='color:#9aa7bd'>Single Port App: UI, health, router, compatibilidad, cola de modelos y runs viven en 8010.</p>
